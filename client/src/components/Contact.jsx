...
function Contact() {
  return (
    <div className="border-2  border-white rounded-tl-[200px] rounded-br-[200px] w-screen flex flex-col justify-center items-center p-8 mt-8 text-white pl-[100px] pr-[100px]" title="Contact Me">
      ...
      <form  action = "https://formspree.io/f/xpzeyyae" method = "post" className="flex flex-col gap-4 lg:w-1/2 h-1/2"> 
         <label htmlFor = "mail" className="flex flex-row items-center text-black">
          Enter your email-id: <input type = "email" name = "email-id" id = "mail" className="ml-4 p-1 text-lg rounded-[5px]" />
         </label>

         <textarea className="text-black p-2 rounded-[5px]" placeholder = "Enter your message here....." name = "message" id = "message"></textarea>

         <div className="flex justify-center items-center">
          <input type="submit" value = "SEND" name="submit" id="send-button" className="bg-white text-black hover:bg-sky-400 p-1 text-lg rounded-[5px] active:p-0" />
         </div>         
      </form> 
