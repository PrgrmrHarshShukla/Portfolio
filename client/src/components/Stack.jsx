...
function Stack() {
  return (
    <div className="min-h-[500px] w-screen px-8 border-2 border-black dark:border-white rounded-tl-[200px] rounded-br-[200px] mt-8 flex flex-col sm:flex-row pt-[100px] pb-[100px]">

      <div className="min-h-[100px] sm:w-1/3 text-3xl flex flex-row justify-center items-start sm:pt-[50px] text-black dark:text-white font-semibold">
         <p>Skills</p>
      </div>
