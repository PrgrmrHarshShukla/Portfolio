   ...
   return (
      <div className={`flex flex-col ${props.isDark ? "border-white " : "border-black "} w-screen h-screen pl-4 border-b-2`}>
         ...
         <div className="h-1/6 flex flex-row justify-between items-center text-white pr-12">
            <button className="border-2 px-2 py-1 rounded-full" onClick={props.toggle}>
               <i
                  className={`fas fa-${props.isDark == true ? "moon text-white" : "sun text-black"} text-lg`} 
               ></i>
            </button>
         ...
         <div className="h-3/5 flex flex-col justify-center items-start text-left lg:items-center lg:text-center">
            ...
            show ? "transform translate-x-0 transition ease-in duration-1000" : "transform translate-x-full"
               ...
               <h1 className={`${props.isDark ?  "text-white " : "text-black "} text-3xl hover:text-red-400  transition-all duration-1000 ease-in-out`}>Hello,</h1>
               <h1 className={`${props.isDark ?  "text-white " : "text-black "} text-5xl font-serif`}>
               ...
               <h1 className={`${props.isDark ?  "text-white " : "text-black "} text-3xl font-semibold font-serif hover:ml-8 hover:text-red-600 transition-all duration-500`}>
                  Front-End Developer
               </h1>
            </div>
         </div>
         ...
         <div className={`h-1/3 flex flex-col justify-center items-start text-left ${props.isDark ?  "text-white " : "text-black "} text-xl lg:items-center lg:text-left ${
         show ? "transform translate-x-0 transition ease-in duration-1000" : "transform translate-x-full"
         }`}>
            ...
            <p className={`hover:cursor-pointer font-semibold lg:border-2 lg:rounded-full lg:px-8 ${props.isDark ?  "border-white " : "border-black "} hover:bg-gradient-to-bl from-white to-blue-500 hover:text-black`}>
